...
public class Theme2af implements Parcelable {
    private int image;
    private int title;
    ...
    private int editText7 = NO_EDITTEXT_PROVIDER;
    ...
    private String editTextValue7;

    public Theme2af(int Image, int Title, int EditText1,
                    int TextView2, int EditText3, int EditText4,
                    int EditText6, int EditText7){
        this.image =Image;
        this.title = Title;
    ...
    public Theme2af(int Image, int Title, int EditText1,
                    ...
                    int EditText3, int EditText4, int TextView3, int EditText5,
                    int EditText6, int EditText7){
        this.image = Image;
        this.title = Title;
        this.editText1 = EditText1;
    ...
    private Theme2af(Parcel in) {
        ...
        editText7 = in.readInt();
    }

    public static final Creator<Theme2af> CREATOR = new Creator<Theme2af>() {
        @Override
        public Theme2af createFromParcel(Parcel in) {
            return new Theme2af(in);
        }

        @Override
        public Theme2af[] newArray(int size) {
            return new Theme2af[size];
        }
    };
    ...
    public int getEditText7() {
        return editText7;
    }

    public void setEditTextValue7(String editTextValue) {
        editTextValue7= editTextValue;
    }

    public boolean hasEditText7() {
        return editText7 != NO_EDITTEXT_PROVIDER;
    }
